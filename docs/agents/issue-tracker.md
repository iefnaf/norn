...
Issues and specs for this repo live as GitHub issues in `iefnaf/norn`. Use the `gh` CLI for all operations.
...
Create a GitHub issue in `iefnaf/norn`.
...
- **Frontier query**: select an open, unassigned child whose blockers are closed.
- **Claim**: `gh issue edit <n> --add-assignee @me`.
- **Resolve**: comment with the result, close the child, and update the map’s decisions.
