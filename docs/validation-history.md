# Norn validation history

> Historical record of the first live validation on 2026-09-22. For the current executable procedure, use [`validation-runbook.md`](validation-runbook.md).

What an operator actually ran to validate Norn end-to-end against the
